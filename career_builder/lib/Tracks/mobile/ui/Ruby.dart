...
class Ruby extends StatefulWidget {
  @override
  _Ruby createState() => _Ruby();
}

class _Ruby extends State<Ruby> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            containerOfAboutOfInfo('assets/Tracks/mobile development/images/ruby.PNG',
              ...
              child: Container(
                ...
                child:Column(
                  ...
                  children: <Widget>[
                    ...
                    containerOfFeature("Ruby", "Fast", "Ruby", "yes", "VScode"),
