    ...
    return new MaterialApp(
      home: new Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              containerOfAboutOfInfo('assets/Tracks/Web/bootsstrapcover.png',  "Bootstrap is the most popular CSS Framework"
                ...
                child: Container(
                  ...
                  child:Column(
                    ...
                    children: <Widget>[
                      ...
                      containerOfFeature("Mark Otto ", "fast", "html/css/javascript", "yes", "Bootstrap Studio"),
