...
class containerOfFeature extends StatelessWidget {
  ...
  final String IDE;
  const containerOfFeature(this.framework,this.devolpmentSpeed,this.programingLang,this.opensource,this.IDE);
  @override
        ...
        children: <Widget>[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              border:Border(
                bottom: BorderSide(width: 2,color:Color(0xff09d8d2),style: BorderStyle.solid,),
              ),
