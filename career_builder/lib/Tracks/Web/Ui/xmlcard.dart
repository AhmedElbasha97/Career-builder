...
class xmlcard extends StatefulWidget {
  @override
  _xmlcardState createState() => _xmlcardState();
}

class _xmlcardState extends State<xmlcard> {
  List<courses> course =[

    courses("khaled elsadani", 2, "assets/Tracks/Web/boy.png", "assets/Tracks/Web/xmlcover.png", "https://www.youtube.com/watch?v=hy58JWK5z-E&list=PLwj1YcMhLRN1xCszZaYI3tFhwdIv7__k6", 4.2, 7),
  ];
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('assets/Tracks/Web/xml.jpg'),
                          fit: BoxFit.fill,
                          alignment: Alignment.topCenter
                      ),
                    ),
