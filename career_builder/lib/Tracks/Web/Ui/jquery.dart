...
class jquery extends StatefulWidget {
  @override
  _jqueryState createState() => _jqueryState();
}

class _jqueryState extends State<jquery> {
  @override
    ...
    return new MaterialApp(
      home: new Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              containerOfAboutOfInfo('assets/Tracks/Web/jquerycover.png',  "jQuery is a lightweight 'write less do more' JavaScript library ."),
              Align(
                ...
                child: Container(
                  ...
                  child:Column(
                    ...
                    children: <Widget>[
                      ...
                      containerOfFeature("the jQuery team", "moderate", "javascript ", "yes", "Eclipse/ Komodo edit"),
