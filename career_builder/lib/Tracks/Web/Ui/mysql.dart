    ...
    return new MaterialApp(
      home: new Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              containerOfAboutOfInfo('assets/Tracks/Web/mysqlcover.png',  "MySQL is the world's most popular open source database."
                  ...
                  "used by high profile web properties including Facebook, Twitter, YouTube, "
                  "Yahoo! and many more."),
              Align(
                ...
                child: Container(
                  ...
                  child:Column(
                    ...
                    children: <Widget>[
                      ...
                      containerOfFeature("oracle corporation", "moderate", "c/c++", "yes", "nevi cat /heidi sql"),
                      //Todo:- ده الجزاء الخاص بى الجزاء بتاعالزراير الفى اخر الشاشه
                      ContainerOfLearAndTestButton(7),
                    ],
                  ),
                ),
              ),
