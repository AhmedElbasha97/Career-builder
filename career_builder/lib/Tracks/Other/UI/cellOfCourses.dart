  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        //that enable to click on container
        onTap: () {
          _launchURL(myUrl);
        },
            ...
            child: Column(
              children: <Widget>[
                ClipRRect(
                  ...
                  child: Image.asset(imgCont,
                      width: 380, height: 170, fit: BoxFit.fill),
...
_launchURL(String url) async {
  if (await canLaunch(url)) {
    ...
    return Alert(
            title: "re connectto the internet please",
            desc: "there's nothing to show")
        .show();
  }
}
