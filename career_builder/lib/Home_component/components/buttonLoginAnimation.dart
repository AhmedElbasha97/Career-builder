...
//  final Function onTapTow;
  final Widget child;
  final Function pressEvent;


  const ButtonLoginAnimation({Key key, this.label, this.background, this.borderColor, this.fontColor, this.onTap,  this.child, this.pressEvent}) : super(key: key);
